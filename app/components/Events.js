...
{/* Flashlight bg */}
  ...
  <span className="absolute bottom-15 right-[-20] w-2 h-10 bg-white"></span>
        ...
        <div
          ref={scrollRef}
          className="overflow-x-auto whitespace-nowrap scroll-smooth p-[-10] no-scrollbar px-4 pb-4 pl-4"
          style={{ scrollPaddingInline: "20px" }}
        >
          <div className="flex gap-8 snap-x snap-mandatory w-max">
        ...
        <div className="flex justify-center space-x-6 mt-12">
          <button
            onClick={() => scroll("left")}
            className="p-3 bg-white/10 border border-white/20 rounded-md hover:bg-white/20"
          >
            &lt;
          </button>
          <button
