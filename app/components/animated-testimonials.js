...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto px-2 sm:px-4 antialiased md:px-8 lg:px-12">
      ...
      <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-purple-900/20 via-indigo-900/15 to-violet-900/20 backdrop-blur-xl border border-white/10 shadow-2xl shadow-purple-500/25 p-4 sm:p-6 md:p-12 lg:p-16 overflow-hidden h-[460px] sm:h-[520px] md:h-[580px] lg:h-[480px] xl:h-[560px] 2xl:h-[600px]">
        ...
        <div className="relative grid grid-cols-1 gap-4 sm:gap-6 md:gap-8 lg:gap-16 xl:gap-24 2xl:gap-64 lg:grid-cols-2">
          ...
          <div className="order-2 lg:order-2 flex flex-col py-2 sm:py-4 md:py-6 lg:py-8 xl:py-12 h-full">
            <div className="flex-grow flex flex-col justify-start pb-20 sm:pb-24 md:pb-28">
              <motion.div
                key={active}
                initial={{
                  y: 20,
        ...
        <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 lg:bottom-12 xl:bottom-16 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2 sm:gap-3 md:gap-4 lg:gap-6 z-50">
