...
const SectionHeading = ({ 
  ...
  return (
    <div className={containerClassName}>
      {/* Top-left corner */}
      <span className="absolute top-[-18px] left-[-26px] w-10 h-2 bg-purple-300"></span>
      <span className="absolute top-[-18px] left-[-26px] w-2 h-10 bg-purple-300"></span>

      {/* Bottom-right corner */}
      <span className="absolute bottom-15 right-[-20px] w-10 h-2 bg-purple-300"></span>
      <span className="absolute bottom-15 right-[-20px] w-2 h-10 bg-purple-300"></span>
