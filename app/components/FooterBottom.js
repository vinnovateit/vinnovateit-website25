...
export default function FooterBottom() {
  return (
    <div className="relative z-30 w-full rounded-t-[40px] border-t border-l border-r drop-shadow-[0_0_40px_rgba(160,97,255,0.7)] shadow-[0_0_30px_rgba(160,97,255,0.8)] px-6 md:px-8 pb-8 pt-10 font-jakarta bg-black md:bg-black/75">
      <div className="flex flex-col md:flex-row justify-between items-center gap-10 md:gap-8">
        ...
        <div className="flex flex-col items-center md:items-end gap-1 md:gap-6 w-full md:w-auto">
          ...
          <a href="mailto:vinnovateit@gmail.com">
            <button className="mt-5 bg-gradient-to-r from-purple-600 to-purple-800 text-white py-2.5 px-6 md:py-3 md:px-8 rounded-full shadow-lg hover:scale-105 hover:shadow-[0_0_25px_rgba(160,97,255,0.7)] transition-all duration-300 font-medium font-orbitron">
              Let&apos;s connect
            </button>
          </a>
        </div>
