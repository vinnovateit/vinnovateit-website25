        ...
        <div className="flex flex-col items-center md:items-end gap-1 md:gap-6 w-full md:w-auto">
          ...
          <a href="mailto:vinnovateit@gmail.com">
            <button 
              ...
              aria-label="Send email to connect with VinnovateIT"
            >
              Let&apos;s connect
            </button>
          </a>
