...
const ProjectShowcase = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Pin the flower only during the scroll section
      ScrollTrigger.create({
        trigger: stickyRef.current,
        start: "top top",
        end: `+=${scrollDistance}`,
  ...
  return (
    ...
    >
      ...
      <div className="w-screen flex flex-col items-center z-30 relative">
        <section
          ref={stickyRef}
          className="relative z-40 min-h-screen w-screen flex flex-col items-center justify-center overflow-hidden"
        >
          {/* Star Background */}
          <div className="absolute inset-0 z-0">
            <AnimatedStarsBackground variant="structured" starCount={80} zIndex={1} />
          </div>
